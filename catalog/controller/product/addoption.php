...
* */
class ControllerProductAddoption extends Controller {
	
	public $options_container 			= '#product';
	public $old_price_container		 	= '#price_old';
	public $tax_price_container 		= '#price_tax';
	public $special_price_container		= '#price_special';
	...
	public function index() {
		...
		$cache_key = 'add_option'. md5($product_id . $quantity. $options_hash . $this->currency->getCode() . $this->session->data['language']);
